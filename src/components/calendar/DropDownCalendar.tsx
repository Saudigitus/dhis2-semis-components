...
export default function DropDownCalendar(props: DropDownCalendarProps) {
    const { setValue, dateDisabler, label, icon, value } = props
        ...
        <>
            ...
            >
                <Paper>
                    ...
                    <Calendar dateDisabler={dateDisabler} setValue={setlocalDateSelected} value={localDateSelected} />
                    <div className={style.datepickerButtons}>
                        <Button onClick={() => { closeAnchor() }} color="primary" className="mb-2">CANCEL</Button>
                        <Button disabled={dateDisabler && dateDisabler(localDateSelected.selectedDate)} onClick={() => {

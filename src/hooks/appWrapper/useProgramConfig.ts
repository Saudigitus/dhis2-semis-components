  ...
  results: {
    ...
    params: {
      fields: [
        ...
        "programSections[id,displayName,description,sortOrder,trackedEntityAttributes[id]]",
        ...
        "programStages[id,displayName,autoGenerateEvent,repeatable,translations,programStageSections[id,displayName,description,sortOrder,dataElements[id]],programStageDataElements[translations,name,displayName,displayInReports,compulsory,dataElement[translations,id,displayName,formName,name,valueType,optionSet[options[translations,style,code~rename(value),displayName~rename(label)]]]]]"
      ]
    }
  }
})
